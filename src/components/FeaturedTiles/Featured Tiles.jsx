...
const FeaturedTiles = async () => {
    ...
    return (
        ...
        <div className="text-center py-10">
            <h2 className='text-xl font-semibold text-gray-800 relative inline-block after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-[#d81b99]'>
                OUR Featured Tiles
            </h2>
            <div className='grid grid-cols-4 grid-rows-6 gap-4 p-4 h-[600px] mt-10 border bg-gray-50'>
                {/* Image 1 - Large */}
